...
const Dashboard = ({ data }) => {
  ...
  let [usableDims, setUsableDims] = React.useState({
    w: windowSize.width * 0.75,
    h: windowSize.height * 0.5
  });

  React.useEffect(() => {
    setUsableDims({ w: windowSize.width * 0.75, h: windowSize.height * 0.5 });
  }, [windowSize]);
  ...
  return (
    <React.Fragment>
      ...
      <BarChart data={data} xScale={xScale} yScale={yScale} dims={usableDims} />
